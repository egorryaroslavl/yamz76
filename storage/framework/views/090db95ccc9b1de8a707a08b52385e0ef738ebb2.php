        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="exampleModalLabel">
                    Пакетное изменение цен в категории [ <?php echo e($data->category->name); ?> ]</h4>
            </div>
            <div class="modal-body">
                <p style="font-weight:bold;padding: 10px ">Вами выбрано для изменения <?php echo e(count( $ids )); ?> позиций</p>
                <div class="row">
                    <div class="col-md-6">
                ...
                <input type="hidden" id="ids" name="ids" value="<?php echo e($data->ids); ?>">
                <input type="hidden" id="category_id" name="category_id" value="<?php echo e($data->category->id); ?>">
            </div>
