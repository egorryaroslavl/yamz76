	...
	class Article extends Section implements Initializable
	{
		...
		public function initialize()
		{
			$this->addToNavigation( $priority = 900, function (){
				return \App\Model\Article::count();
			} );
		...
		public function onDisplay()
		{
			return AdminDisplay::datatables()
				...
				->setHtmlAttribute( 'class', 'table-articles' )
				->setHtmlAttribute( 'data-table', 'articles' )
				->setTitle( 'Статьи' )
				->setColumns(
					AdminColumn::custom()->setLabel( 'Reorder' )
						->setCallback(
							function (){
								return '<input type="hidden" class="table"  name="table" value="articles">';
					...
					AdminColumn::custom()
						...
						->setCallback( function ( \App\Model\Article $model ){
