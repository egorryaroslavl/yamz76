...
@section('content')
	...
	<div class="wrapper wrapper-content animated fadeInRight">
		<div class="row border4 mb-10 p10 block-wrap">
			...
			{{ Widget::PartsBlock('position', 'a') }}
			{{ Widget::PartsBlock('position', 'b') }}
			{{ Widget::PartsBlock('position', 'c') }}
